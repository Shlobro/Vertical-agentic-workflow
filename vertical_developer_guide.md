...
- `InputBar` handles enter-to-send, shift-enter newline, textarea auto-growth, provider/model selection, cancellation of the active provider request, and composer text scaling through the shared workspace text-zoom preferences. It stays hidden until a chat is selected.
