...
- `ChatSession` carries an optional `hasUnreadCompletion` flag for the sidebar's green "finished in background" indicator, which clears as soon as that chat is opened.
