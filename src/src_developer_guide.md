...
7. A debounced save path invokes `save_workspace_state` after relevant project/chat changes and sidebar-ratio changes so project folders and the workspace registry stay synchronized with the in-memory store.
