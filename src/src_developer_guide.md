...
7. A debounced store subscription invokes `save_workspace_state` after relevant project/chat changes so project folders and the workspace registry stay synchronized with the in-memory store.
