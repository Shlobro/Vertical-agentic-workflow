...
- This folder is responsible for process spawning, active child-process tracking, stdout/stderr parsing, provider timeouts, event emission back into the window, and local workspace/project persistence.
