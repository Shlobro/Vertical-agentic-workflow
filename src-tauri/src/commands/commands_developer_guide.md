...
- Keep project file indexing bounded and explicit. Skip internal or generated directories that would flood composer suggestions, and always return normalized relative paths rather than absolute filesystem paths.
