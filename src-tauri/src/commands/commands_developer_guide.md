...
- Keep repo-root onboarding rules in persistence commands too, including the exact default content for companion markdown files and the rule that existing files are never overwritten.
